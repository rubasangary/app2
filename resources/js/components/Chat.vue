<template>
    ...
    <div>
         ...
         <div class="flex flex-1 bg-gray-100 dark:bg-gray-900 h-screen lg:max-w-screen-2xl mb-2">
            <div class="lg:p-20 w-full mb-10">
                <div class="max-h-full h-full block lg:flex lg:flex-row">
                    ...
                    <!-- Right Section Start  -->
                            <div class="lg:relative m-h-ful h-full bg-white rounded-lg w-full flex flex-col dark:bg-gray-800 shadow-lg">
                                ...
                                <div class="flex p-3 justify-between">
                                    <div class="text-xl font-semibold dark:text-gray-300 text-gray-900" >
                                        Chat (அரட்டை)
                                    </div>
                                    <div>
                                                            ...
                                                            <div class="flex justify-end">
                                                                <div class="space-y-5 text-right">
                                                                    <div class="flex justify-end mt-2">
                                                                        <img class="rounded-full w-10 h-10 lg:w-12 lg:h-12 mr-2" :src="(message.user.profile_photo_url)" alt="" srcset="">
                                                                        <p class="mt-2">{{ message.user.name }}</p>
                                                                    </div>
                                                                    <div>

                                                                        <div class="block bg-green-200 p-2 mt-1 rounded-l-lg rounded-b-lg max-w-xl">
                                                                            <div>
                                                                                <div class="text-base text-gray-900 text-left">
                                                                                    {{ message.body }}
                                                                                </div>

                                                                                <div class="text-sm mt-2 text-gray-600">{{ moment(message.created_at).fromNow() }}</div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="flex-row mt-5 justify-start">
                                                                        ...
                                                                        <div class="flex flex-col mt-2 text-left w-1/2">
                                                                            <div>
                                                                                ...
                                                                                <div class="block bg-blue-400 text-gray-900 p-2 rounded-r-lg rounded-b-lg max-w-xl">
                                    ...
                                    <div class="flex-none p-2">
                                        <div>
                                            <div class="relative flex mr-5 mb-2">
                                                <input v-model="body" type="text" placeholder="Type here...." class="w-4/6 md:w-full focus-outline-none  placeholder-gray-400 pl-8 bg-gray-200 pr-8 rounded-full mb-1 dark:bg-gray-800 focus:placeholder-gray-400 text-gray-400">
