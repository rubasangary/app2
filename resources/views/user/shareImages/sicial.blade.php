<div class="mb-6">
    <label class="text-gray-700 dark:text-gray-300" for="">
        <i class="fa-brands fa-instagram fa-lg mr-1" style="color: #cf2075;"></i>
        Instagram (URL)
    </label>
    <input class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="yt_iframe" value="{{ old('link') }}" type="url">
</div>
<div class="mb-6">
    <label class="text-gray-700 dark:text-gray-300" for="">
        <i class="fa-brands fa-pinterest fa-lg mr-1" style="color: #df262f;"></i>
        Pinterest (URL)
    </label>
    <input class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="yt_iframe" value="{{ old('link') }}" type="url">
</div>
<div class="mb-6">
    <label class="text-gray-700 dark:text-gray-300" for="">
        <i class="fa-brands fa-unsplash fa-lg mr-1" style="color: #a8b5cc;"></i>
        Unsplash (URL)
    </label>
    <input class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="yt_iframe" value="{{ old('link') }}" type="url">
</div>
<div class="mb-6">
    <label class="text-gray-700 dark:text-gray-300" for="">
        <i class="fa-brands fa-facebook fa-lg mr-1" style="color: #0d52c9;"></i>
        Facebook Page (URL)
    </label>
    <input class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="yt_iframe" value="{{ old('link') }}" type="url">
</div>
<div class="mb-6">
    <label class="text-gray-700 dark:text-gray-300" for="">
        <i class="fa-brands fa-youtube fa-lg mr-1" style="color: #c12626;"></i>
         Youtube Channel (URL)
    </label>
    <input class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="yt_iframe" value="{{ old('link') }}" type="url">
</div>
