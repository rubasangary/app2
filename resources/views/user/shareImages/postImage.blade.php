...
<h3 class="ml-2 lg:mt-8 text-blue-800 dark:text-blue-600 text-2xl font-semibold">Upload Image <i class="fa-solid fa-upload fa-sm"></i></h3>
...
<div>
    <div class="mt-6">
        ...
        <form method="POST" action="{{ url('blog/store-image') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="p-6 rounded-md shadow-md mb-10 bg-white dark:bg-gray-800">
                    ...
                    <div class="mb-6 w-full">
                        ...
                        <select class="w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="image_category_id" data-te-select-init>
                        ...
                        <div class="mb-6">
                            <label class="text-gray-700 dark:text-gray-300" for="">Image Title</label>
                        ...
                        <div class="mb-6">
                            <label class="text-gray-700 dark:text-gray-300" for="">Description</label>
                            <textarea class="form-input w-full mt-2 rounded-md border-gray-800 focus:border-indigo-800 dark:bg-gray-900" name="description"  id="" cols="30" rows="5">{{ old('description') }}</textarea>
                        </div>
