    ...
    <div class="flex flex-col mt-8">
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            ...
            <section class="container px-4 mx-auto">
                <h2 class="text-lg font-medium text-gray-800 dark:text-white">Manage Blogs</h2>

                <p class="mt-3 text-sm text-gray-500 dark:text-gray-300">இங்கே உங்கள் பதிவுகளை கையாளவும்</p>
                            ...
                            <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-1 py-1 text-sm whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <img src="{{ asset('/storage/blogPost/' . $ad->image) }}" class="object-cover w-10 h-10 rounded-full lg:w-24 lg:h-20 lg:mx-1 lg:rounded-md border-2 border-white dark:border-gray-700 shrink-0" alt="">

                                                </div>
                                            </td>
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div>
                                                    <p class="text-gray-500 dark:text-gray-400">{{ $ad->title }}</p>
                                                </div>
                                            </td>
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div>
                                                <p class="text-gray-500 dark:text-gray-400">You do not have any posts to show</p>
                                            </div>
                                        </td>
                                        @endforelse
