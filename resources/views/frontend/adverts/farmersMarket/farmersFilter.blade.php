                            ...
                            <div x-data="{ open: false }" class="relative lg:flex lg:space-x-2">
                                ...
                                <div class="lg:absolute lg:mt-20 mt-2 mb-2">
                                    <ul
                                        ...
                                        <a href="{{ route('farmersFilter', $subMenu->slug) }}" class="block rounded-md hover:bg-blue-600 whitespace-no-wrap py-1 px-4">
                                        <li>
                                        {{ $childMenu->name }}
                                        </li>
                                        </a>
