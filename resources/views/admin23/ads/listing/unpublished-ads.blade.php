...
<div class="w-full mt-6">
    ...
    <div class="flex justify-between">
        <p class="text-xl pb-3 flex items-center text-gray-700 font-semibold">
            <i class="fas fa-list mr-3"></i> Unublished Ads
        </p>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b bg-neutral-100 dark:border-neutral-500 dark:bg-neutral-700">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 font-medium">
                                <a target="_blank" href="{{ route('user.showProduct', $ad->adPostedBy->slug) }}">
                                    @if ($ad->adPostedBy->profile_photo_url)
                                        <img src="{{ $ad->adPostedBy->profile_photo_url }}" width="60px" height="50px">
                                    @else
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <img src="{{ asset('/storage/ads/seller/' . $ad->feature_image) }}" width="60px" height="50px" alt="" srcset="">
                            </td>

                            <td>
                                <a
                                    href="{{ route('publish.now', $ad->id) }}">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 ">
                                ...
                                href="{{ route('product.show', [$ad->id, $ad->slug]) }}">View</a>
                            </td>
