...
<div class="w-full mt-6">
    ...
    <div class="flex justify-between">
        <p class="text-xl pb-3 flex items-center text-gray-700 font-semibold">
            <i class="fas fa-list mr-3"></i>Manage Pending Posts
        </p>
    </div>
                ...
                <div class="overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b bg-neutral-100 dark:border-neutral-500 dark:bg-neutral-700">
                            ...
                            <td>
                                <a
                                    href="{{ route('post-now', $post->id) }}">
                                    <button class="font-semibold text-sm bg-green-700 hover:bg-green-500 py-1 px-2 text-white rounded">{{ $post->status == '1' ? 'Published' : 'Approve Now'}}</button>
                                </a>
                            </td>
                            ...
                            <td class="whitespace-nowrap px-6 py-4 ">
                                <a class="font-semibold text-sm bg-orange-700 hover:bg-orange-500 py-1 px-2 text-white rounded" target="_blank"
                        ...
                        @empty
                        <td>No Pending Posts to display</td>
                        @endforelse
